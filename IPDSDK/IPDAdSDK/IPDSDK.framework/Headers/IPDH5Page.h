...
@interface IPDH5Page : IPDAd

@property (nonatomic, weak) id <IPDH5PageDelegate> delegate;
 ...
 */
- (instancetype)initWithPlacementId:(NSString *)placementId user:(IPDUser *)user delegate:(id <IPDH5PageDelegate>)delegate;
...
/**
 ...
 如需设置 IPDH5Page+IPDCustom.h 内的H5页面相关UI，请在设置后再调用该方法跳转
 */
