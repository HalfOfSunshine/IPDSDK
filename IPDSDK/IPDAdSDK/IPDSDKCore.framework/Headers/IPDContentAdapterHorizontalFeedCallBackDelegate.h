//
//  IPDContentAdapterHorizontalFeedCallBackDelegate.h
//  IPDSDKCore
//
...
@protocol IPDContentAdapterHorizontalFeedCallBackDelegate <IPDAdapterContentAdapterVideoStateDelegate, IPDContentAdapterStateDelegate>
@optional
/// 进入横版视频详情页
