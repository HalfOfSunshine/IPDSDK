...
typedef NS_ENUM(NSInteger, IPDAdMaterialType) {
    IPDAdMaterialTypeUnkown      =       0,      // 未知
    IPDAdMaterialTypeVideo       =       1,      // 视频
    IPDAdMaterialTypeSingle      =       2,      // 单图
    IPDAdMaterialTypeAtlas       =       3,      // 多图
};
NS_ASSUME_NONNULL_BEGIN

@interface IPDNativeAdObject : NSObject

/**
 广告类型
 */
@property (nonatomic, readonly) IPDAdMaterialType materialType;
