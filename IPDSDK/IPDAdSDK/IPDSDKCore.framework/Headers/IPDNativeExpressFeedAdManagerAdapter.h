...
#import "IPDNativeExpressFeedAd.h"
#import <UIKit/UIKit.h>
NS_ASSUME_NONNULL_BEGIN
@protocol IPDNativeExpressFeedAdManagerApterDelegate;
@interface IPDNativeExpressFeedAdManagerAdapter : IPDCoreAdAdapter
...
- (void)IPDFeed_feedAdsManagerSuccessToLoad:(IPDNativeExpressFeedAdManagerAdapter *)adsManager nativeAds:(NSArray<IPDNativeExpressFeedAd *> *_Nullable)feedAdDataArray;
